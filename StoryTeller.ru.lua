...
StoryTeller.Msg.STARTUP = "StoryTeller v{версия}."
...
StoryTeller.Msg.PLAYER_TOOLTIP_VERSION = "StoryTeller v{версия}"
StoryTeller.Msg.TOOLTIP_LEFT_CLICK = "**ЛКМ**: {действие}"
StoryTeller.Msg.TOOLTIP_RIGHT_CLICK = "**ПКМ**: {действие}"
